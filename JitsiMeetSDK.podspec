Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/SCSoft-Bilisim-Teknolojileri/jitsi-meet-ios-sdk-custom-releases'
  s.license          = 'Apache 2'
  s.authors          = 'The Jitsi Meet project authors'
  s.source           = { :git => 'https://github.com/SCSoft-Bilisim-Teknolojileri/jitsi-meet-ios-sdk-custom-releases.git', :tag => s.version }
  s.platform         = :ios, '12.0'
  s.swift_version    = '5'
